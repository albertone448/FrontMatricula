			...
			<div className='max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center'>
				...
				<div className="relative">
					<button
						...
						className="flex items-center space-x-3 text-gray-300 hover:text-gray-100 transition duration-200 focus:outline-none"
					>
					...
					<AnimatePresence>
						{showDropdown && (
							<motion.div
								...
								className="absolute right-0 mt-2 w-48 bg-gray-800 bg-opacity-95 backdrop-blur-md rounded-lg shadow-lg border border-gray-700 z-50"
							>
								<div className="py-2">
									{/* User Info */}
